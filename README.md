...
| **Generate** (text→image) | AI (Replicate) | manual | Flux Schnell, Flux Dev, SDXL, Recraft v3, Ideogram v2. |
| **Edit** (image + prompt/mask) | AI (Replicate) | manual | Instruct Pix2Pix, Flux Kontext, Relight (IC-Light), SD Inpainting (image + mask + prompt), Flux ControlNet (Canny). |
